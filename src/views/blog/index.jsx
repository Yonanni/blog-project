...
const Blog = (props) => {
  ...
  useEffect(() => {
    ...
    const currentBlog = data.filter(
      (singleBlog) => singleBlog._id == params.id
    );
      ...
      <Container>
        ...
        <div className="mt-5">
          {comments === [] ? (
            ...
            comments.map((c) => (
              <div key={c._id} className="blog-details-comments-container">
                <span className="blog-details-comment-author">{c.name}:</span>
                <span className="blog-details-single-comment">
